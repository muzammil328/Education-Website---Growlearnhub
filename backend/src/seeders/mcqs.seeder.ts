...
export const mcqs = [
  ...
  // ── Cells and Tissues / Cell Structure – extra ─────────────────────────────
  {
    className: 'class-9', bookName: 'Biology', chapterName: 'Cells and Tissues',
    headingName: 'Cell Structure', subHeadingName: 'Eukaryotic Cells',
    questions: [
      { name: 'Which scientist proposed that all animals are made of cells?', options: [{ text: 'Schleiden', is_correct: false }, { text: 'Schwann', is_correct: true }, { text: 'Virchow', is_correct: false }, { text: 'Hooke', is_correct: false }], type: 'multipleChoice' },
      { name: 'Which scientist proposed that all plants are made of cells?', options: [{ text: 'Schwann', is_correct: false }, { text: 'Schleiden', is_correct: true }, { text: 'Virchow', is_correct: false }, { text: 'Hooke', is_correct: false }], type: 'multipleChoice' },
      { name: 'Virchow added to the cell theory by stating?', options: [{ text: 'All organisms are unicellular', is_correct: false }, { text: 'New cells arise only from pre-existing cells', is_correct: true }, { text: 'Cells have no nucleus', is_correct: false }, { text: 'Cells can be created from chemicals', is_correct: false }], type: 'multipleChoice' },
      { name: 'The average diameter of a human cell is approximately?', options: [{ text: '10 nanometres', is_correct: false }, { text: '10 micrometres', is_correct: true }, { text: '10 millimetres', is_correct: false }, { text: '10 centimetres', is_correct: false }], type: 'multipleChoice' },
      { name: 'Cells that are highly active metabolically tend to have?', options: [{ text: 'Few mitochondria', is_correct: false }, { text: 'Many mitochondria', is_correct: true }, { text: 'No nucleus', is_correct: false }, { text: 'No ribosomes', is_correct: false }], type: 'multipleChoice' },
      { name: 'Eukaryotic cells first appeared on Earth approximately?', options: [{ text: '4 billion years ago', is_correct: false }, { text: '1.5–2 billion years ago', is_correct: true }, { text: '500 million years ago', is_correct: false }, { text: '100 million years ago', is_correct: false }], type: 'multipleChoice' },
      { name: 'Which type of cell is typical of fungi?', options: [{ text: 'Prokaryotic', is_correct: false }, { text: 'Eukaryotic with cell wall of chitin', is_correct: true }, { text: 'Eukaryotic with cell wall of cellulose', is_correct: false }, { text: 'Without any cell wall', is_correct: false }], type: 'multipleChoice' },
      { name: 'Tonoplast is the membrane surrounding?', options: [{ text: 'Mitochondria', is_correct: false }, { text: 'The central vacuole in plant cells', is_correct: true }, { text: 'The nucleus', is_correct: false }, { text: 'Chloroplasts', is_correct: false }], type: 'multipleChoice' },
      { name: 'The fluid mosaic model describes?', options: [{ text: 'The structure of DNA', is_correct: false }, { text: 'The structure of the cell membrane', is_correct: true }, { text: 'The structure of the nucleus', is_correct: false }, { text: 'The structure of ribosomes', is_correct: false }], type: 'multipleChoice' },
      { name: 'Phospholipids have?', options: [{ text: 'One hydrophilic head and two hydrophobic tails', is_correct: true }, { text: 'Two hydrophilic heads', is_correct: false }, { text: 'Only hydrophobic parts', is_correct: false }, { text: 'No heads or tails', is_correct: false }], type: 'multipleChoice' },
      { name: 'The hydrophobic tails of phospholipids face?', options: [{ text: 'Outward toward water', is_correct: false }, { text: 'Inward away from water', is_correct: true }, { text: 'Both inward and outward', is_correct: false }, { text: 'Toward the nucleus', is_correct: false }], type: 'multipleChoice' },
      { name: 'Cholesterol in the cell membrane helps to?', options: [{ text: 'Make the membrane more rigid and less fluid', is_correct: false }, { text: 'Regulate fluidity of the membrane', is_correct: true }, { text: 'Allow all molecules to pass', is_correct: false }, { text: 'Produce energy', is_correct: false }], type: 'multipleChoice' },
      { name: 'Glycoproteins on the cell surface are involved in?', options: [{ text: 'Energy production', is_correct: false }, { text: 'Cell recognition and signalling', is_correct: true }, { text: 'DNA storage', is_correct: false }, { text: 'Lipid synthesis', is_correct: false }], type: 'multipleChoice' },
      { name: 'Which cellular process requires energy from ATP?', options: [{ text: 'Simple diffusion', is_correct: false }, { text: 'Osmosis', is_correct: false }, { text: 'Active transport', is_correct: true }, { text: 'Facilitated diffusion', is_correct: false }], type: 'multipleChoice' },
      { name: 'Which organelle is the site of lipid synthesis?', options: [{ text: 'Rough ER', is_correct: false }, { text: 'Smooth ER', is_correct: true }, { text: 'Golgi apparatus', is_correct: false }, { text: 'Ribosome', is_correct: false }], type: 'multipleChoice' },
      { name: 'The nucleolus is visible during?', options: [{ text: 'Cell division', is_correct: false }, { text: 'Interphase (when cell is not dividing)', is_correct: true }, { text: 'Mitosis only', is_correct: false }, { text: 'Meiosis only', is_correct: false }], type: 'multipleChoice' },
      { name: 'Chromatin condenses into chromosomes during?', options: [{ text: 'Interphase', is_correct: false }, { text: 'Cell division', is_correct: true }, { text: 'Protein synthesis', is_correct: false }, { text: 'Respiration', is_correct: false }], type: 'multipleChoice' },
      { name: 'The nuclear pores are made of?', options: [{ text: 'Lipids', is_correct: false }, { text: 'Protein complexes', is_correct: true }, { text: 'DNA', is_correct: false }, { text: 'Carbohydrates', is_correct: false }], type: 'multipleChoice' },
      { name: 'Secretory cells such as pancreatic cells have many?', options: [{ text: 'Lysosomes', is_correct: false }, { text: 'Rough ER and Golgi apparatus', is_correct: true }, { text: 'Vacuoles', is_correct: false }, { text: 'Chloroplasts', is_correct: false }], type: 'multipleChoice' },
      { name: 'Plant cells are rigid because of?', options: [{ text: 'Chloroplasts', is_correct: false }, { text: 'The cell wall', is_correct: true }, { text: 'Large vacuoles alone', is_correct: false }, { text: 'Mitochondria', is_correct: false }], type: 'multipleChoice' },
      { name: 'The sap vacuole in plant cells contains?', options: [{ text: 'DNA', is_correct: false }, { text: 'Dissolved substances in cell sap', is_correct: true }, { text: 'Chlorophyll only', is_correct: false }, { text: 'Ribosomes', is_correct: false }], type: 'multipleChoice' },
      { name: 'Eukaryotic cells are found in which kingdoms?', options: [{ text: 'Monera only', is_correct: false }, { text: 'Protista, Fungi, Plantae, Animalia', is_correct: true }, { text: 'All five kingdoms', is_correct: false }, { text: 'Bacteria and Archaea', is_correct: false }], type: 'multipleChoice' },
      { name: 'Which scientist first described bacteria as "animalcules"?', options: [{ text: 'Robert Hooke', is_correct: false }, { text: 'Anton van Leeuwenhoek', is_correct: true }, { text: 'Pasteur', is_correct: false }, { text: 'Koch', is_correct: false }], type: 'multipleChoice' },
      { name: 'Cell fractionation is used to?', options: [{ text: 'Kill cells', is_correct: false }, { text: 'Separate cell organelles for study', is_correct: true }, { text: 'Stain cells', is_correct: false }, { text: 'Grow cells in culture', is_correct: false }], type: 'multipleChoice' },
      { name: 'The technique used to observe internal cell ultrastructure is?', options: [{ text: 'Light microscopy', is_correct: false }, { text: 'Electron microscopy', is_correct: true }, { text: 'X-ray imaging', is_correct: false }, { text: 'MRI scanning', is_correct: false }], type: 'multipleChoice' },
    ],
  },
];
