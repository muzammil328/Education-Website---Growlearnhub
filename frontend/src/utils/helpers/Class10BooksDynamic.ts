...
export interface Class10BookMedium {
  slug: MediumSlug;
  name: string;
  fileId: string;
}

export interface Class10BookBoard {
  slug: string;
  name: string;
  image: string;
  summary: string;
  mediums: Class10BookMedium[];
  chapterCount: number;
}

export const CLASS10_PUNJAB_BOARDS: Class10BookBoard[] = [
  {
    slug: 'punjab-board-biology',
    name: 'Biology',
    image: '/10th/book/punjab/class_10_biology_book_punjab_board.webp',
    summary: 'Download Class 10 Biology Punjab Board textbook in English and Urdu medium.',
    chapterCount: 20,
    mediums: [
      {
        slug: 'english-medium',
  ...
  },
  {
    ...
    summary: 'Access Class 10 Chemistry Punjab Board textbook PDF in both mediums.',
    chapterCount: 20,
    mediums: [
      {
        slug: 'english-medium',
  ...
  },
  {
    ...
    summary: 'Read and download Class 10 Physics Punjab Board book for exam preparation.',
    chapterCount: 20,
    mediums: [
      {
        slug: 'english-medium',
  ...
  },
  {
    ...
    summary: 'Download 10th Class Math Punjab Board textbook in English and Urdu medium.',
    chapterCount: 20,
    mediums: [
      {
        slug: 'english-medium',
  ...
  },
  {
    ...
    summary: 'Get Class 10 English Punjab Board textbook PDF for guided reading.',
    chapterCount: 20,
    mediums: [
  ...
  },
  {
    ...
    summary: 'Download Class 10 Urdu Punjab Board book in PDF format.',
    chapterCount: 20,
    mediums: [
  ...
  },
  {
    ...
    summary: 'Access Class 10 Economics Punjab Board textbook with complete syllabus coverage.',
    chapterCount: 20,
    mediums: [
  ...
  },
  {
    ...
    summary: 'Read Class 10 Islamiyat Punjab Board textbook online or download as PDF.',
    chapterCount: 20,
    mediums: [
  ...
  },
  {
    ...
    summary: 'Download Class 10 Ikhlaqiat Punjab Board textbook for moral education studies.',
    chapterCount: 20,
    mediums: [
  ...
  },
  {
    ...
    summary: 'Access Tarjuma Tul Quran Class 10 Punjab Board book in PDF format.',
    chapterCount: 20,
    mediums: [
  ...
  },
  {
    ...
    summary: 'Download Class 10 General Math Punjab Board textbook in both mediums.',
    chapterCount: 20,
    mediums: [
      {
        slug: 'english-medium',
  ...
  },
  {
    ...
    summary: 'Read and download Class 10 Pak Study Punjab Board textbook PDFs.',
    chapterCount: 20,
    mediums: [
      {
        slug: 'english-medium',
  ...
  },
  {
    ...
    summary: 'Get Class 10 Computer Science Punjab Board textbook PDFs for both mediums.',
    chapterCount: 20,
    mediums: [
      {
        slug: 'english-medium',
...
export const class10BookBoardCards = [
  {
    title: 'Punjab Board',
    child: CLASS10_PUNJAB_BOARDS.map(board => ({ name: board.name, slug: board.slug })),
  },
];

export function getClass10Board(slug: string): Class10BookBoard | undefined {
  return CLASS10_PUNJAB_BOARDS.find(board => board.slug === slug);
}

export function getClass10Medium(
  board: Class10BookBoard,
  mediumSlug: string
): Class10BookMedium | undefined {
  return board.mediums.find(medium => medium.slug === mediumSlug);
}

export function getClass10Chapters(count: number) {
