...
export default function PastPaperClass12Chapter({ boardSlug, chapterSlug }: Props) {
  ...
  return (
    <>
      <UserLayout
        title={`${chapterName} Past Paper MCQs – Class 12 ${boardName} | GrowLearnHub`}
        ...
        <article className="max-w-none">
          <header>
            ...
            <Para className="text-muted-foreground mt-1">
              {totalRecords > 0 ? `${totalRecords} MCQs` : 'MCQs'} for Class 12 · {boardName}
            </Para>
          </header>
