      ...
      <article className="max-w-none">
        <section className="mb-8">
          <p>
            ...
            in one place. These 10th class textbooks cover the full PCTB and FBISE syllabus for
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold text-primary mb-4">
            Class 10 Subjects — Textbooks Available
          </h2>
          <p className="text-muted-foreground">
            GrowLearnHub provides free PDF downloads for all major Class 10 subjects including{' '}
            ...
            textbooks prescribed by Punjab Board (PCTB) and Federal Board (FBISE) for 10th class
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold text-primary mb-4">
            Why Use These Class 10 Textbooks?
          </h2>
          <ul className="list-disc list-inside space-y-2 text-muted-foreground">
            <li>100% free — no account or payment required</li>
            <li>Covers the full PCTB and FBISE syllabus for 10th class</li>
        ...
        <section className="mb-6">
          <h2 className="text-2xl font-semibold text-primary mb-4">
            Tips for Exam Preparation Using Class 10 Textbooks
          </h2>
          <p className="text-muted-foreground">
