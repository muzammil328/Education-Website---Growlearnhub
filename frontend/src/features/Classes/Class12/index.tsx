  ...
  return (
    ...
    >
      ...
      <div className="mt-10 space-y-2 border-t border-border pt-8">
        <Heading2>Class 12 Study Resources — Complete Guide for Pakistani Students</Heading2>
        <Para>
        ...
        <Heading2>12th Class Notes — All Subjects</Heading2>
        <Para>
        ...
        <Heading2>Chapter-wise MCQs for Class 12</Heading2>
        <Para>
        ...
        <Heading2>Online Tests for 12th Class</Heading2>
        <Para>
        ...
        <Heading2>Class 12 Past Papers — Punjab, Federal &amp; BISE Boards</Heading2>
        <Para>
