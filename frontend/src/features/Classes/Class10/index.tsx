...
export default function Class10({ children }: { children?: React.ReactNode }) {
  const { data: servicesData, isLoading, error } = useServiceByClassSlug('class-10');
      ...
      <div className="mt-10 space-y-2 border-t border-border pt-8">
        ...
        <Accordion type="single" collapsible className="w-full">
          {[
            ...
            {
              value: 'faq-3',
              q: 'How many years of past papers are available for Class 10?',
