  ...
  return (
    ...
    >
      ...
      <div className="mt-10 space-y-2 border-t border-border pt-8">
        <h2>Class 11 Study Resources — Complete Guide for Pakistani Students</h2>
        <p>
        ...
        <h2>11th Class Notes — All Subjects</h2>
        <p>
        ...
        <h2>Chapter-wise MCQs for Class 11</h2>
        <p>
        ...
        <h2>Online Tests for 11th Class</h2>
        <p>
        ...
        <h2>Class 11 Past Papers — Punjab, Federal &amp; BISE Boards</h2>
        <p>
