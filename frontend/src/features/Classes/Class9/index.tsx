...
export default function Class9({ children }: { children?: React.ReactNode }) {
  ...
  return (
    ...
    >
      <p>
        Welcome to the <strong className="font-semibold text-foreground">Class 9</strong> study
      ...
      <div className="mt-10 space-y-2 border-t border-border pt-8">
        <h2>Class 9 Study Resources — Complete Guide for Pakistani Students</h2>
        <p>
        ...
        <h2>9th Class Notes — All Subjects</h2>
        <p>
        ...
        <h2>Chapter-wise MCQs for Class 9</h2>
        <p>
        ...
        <h2>Online Tests for 9th Class</h2>
        <p>
          Sitting a timed online test is the closest thing to sitting a real board exam from home.
          Our <strong className="text-foreground">Class 9 online tests</strong> are organised by
        ...
        <h2>Class 9 Past Papers — Punjab, Federal &amp; BISE Boards</h2>
        <p>
          ...
          <strong className="text-foreground"> 9th class past papers</strong> gives you a clear
