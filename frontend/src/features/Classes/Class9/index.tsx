...
export default function Class9() {
  ...
  return (
    ...
    >
      ...
      <h3 className="text-xl py-2 text-destructive">Online Tests for Class 9</h3>
      <p>
      ...
      />
      <h3 className="text-xl py-2 text-destructive">Past Papers for Class 9</h3>
      <p>
