...
import Class12McqsBookChapterPage from '@/features/McqsPage/Class12/Chapter';
...
function buildData(book: string, chapter: string) {
  ...
  return {
    title: `Class 12 ${bookLabel} ${chapterLabel} Topics`,
    description: `Explore topics in Class 12 ${bookLabel} ${chapterLabel}.`,
    keywords: [`Class 12 ${bookLabel} ${chapterLabel} topics`, `${chapterLabel} MCQs for Class 12`],
      ...
      <article className="space-y-8">
        <header className="space-y-3">
          <Heading2 className="mb-2" weight="bold" size="sm">
            Class 12 {bookLabel} {chapterLabel} Topics
          </Heading2>
          <p className="text-base">
            Move from chapters into the topic hierarchy for {chapterLabel}.
          </p>
        </header>
        <Class12McqsBookChapterPage bookSlug={book} chapterSlug={chapter} />
      </article>
    </UserLayout>
  );
}
