...
function buildData(book: string, chapter: string, heading: string) {
  ...
  return {
    title: `Class 12 ${bookLabel} ${chapterLabel} ${headingLabel} Topics`,
    description: `Explore subtopics in Class 12 ${bookLabel} ${chapterLabel} ${headingLabel}.`,
    keywords: [`Class 12 ${headingLabel} topics`, `${headingLabel} MCQs for Class 12`],
