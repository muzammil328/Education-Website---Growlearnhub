...
function buildData(book: string, chapter: string, heading: string) {
  ...
  return {
    title: `Class 9 ${bookLabel} ${chapterLabel} ${headingLabel} Topics`,
    description: `Explore subtopics in Class 9 ${bookLabel} ${chapterLabel} ${headingLabel}.`,
    keywords: [`Class 9 ${headingLabel} topics`, `${headingLabel} MCQs for Class 9`],
