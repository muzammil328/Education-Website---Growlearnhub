...
function buildData(book: string, chapter: string) {
  ...
  return {
    title: `Class 9 ${bookLabel} ${chapterLabel} Topics`,
    description: `Explore topics in Class 9 ${bookLabel} ${chapterLabel} and continue to topic-specific MCQs.`,
    keywords: [`Class 9 ${bookLabel} ${chapterLabel} topics`, `${chapterLabel} MCQs for Class 9`],
      ...
      <article className="space-y-8">
        <header className="space-y-3">
          <Heading2 className="mb-2" weight="bold" size="sm">
            Class 9 {bookLabel} {chapterLabel} Topics
          </Heading2>
