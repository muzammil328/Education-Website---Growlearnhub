...
function buildData(book: string, chapter: string, heading: string) {
  ...
  return {
    title: `Class 11 ${bookLabel} ${chapterLabel} ${headingLabel} Topics`,
    description: `Explore subtopics in Class 11 ${bookLabel} ${chapterLabel} ${headingLabel}.`,
    keywords: [`Class 11 ${headingLabel} topics`, `${headingLabel} MCQs for Class 11`],
